...
@objc class AppDelegate : UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate
{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool
    {
        ...
        if #available(iOS 10.0, *) {
         ...
         // gm modified            center.delegate=MCENotificationDelegate.shared
            center.delegate=GMNotificationDelegate.shared
    ...
    func application(_ application: UIApplication, didReceive notification: UILocalNotification) {
        ...
        print("*** Got callback to didReceive no ***")
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable : Any]) {
        ...
        print("*** Got callback to didReceiveRemoteNotification AnyHashable no fetch ***")
    }
    

    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable : Any], fetchCompletionHandler completionHandler: @escaping (UIBackgroundFetchResult) -> Void)
    {
        print("*** Got callback to didReceiveRemoteNotification content-available==1***")
